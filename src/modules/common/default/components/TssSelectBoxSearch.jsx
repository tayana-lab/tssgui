...
const TssSelectBoxSearch = ({
  ...
  maxLength = true
	...
	//console.log("defaultValue:::::::::::::in component::"+JSON.stringify(defaultValue));
  const [searchQuery, setSearchQuery] = useState("");
  const [selectOptionValue, setSelectionOptionValue] = useState("");
  ...
  const filterOptions = options.filter(option => {
     const searchStr = (searchQuery || '').toString().toLowerCase();
        ...
        <div style={{ position: 'relative' }} className={`selectHover ${validation} ${disabled ? 'tss-disableField' : ''}`}>
          ...
          {showDropdown && !disabled && (
            ...
            >
		      ...
		      className={`options ${highlightedIndex == index  || element.value == defaultValue.value ? 'tss-selected-option' : ''} `}
...
export default TssSelectBoxSearch;
